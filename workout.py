...
def sets: 
if day in daysof_week 
def random_order_gen:
	random.choice(group_squared)
...
Abdominals_exercises: {“One-Arm Medicine Ball Slam” : 9.5, ”Landmine 180's” : 9.5, ”Plank” : 9.3, ”Elbow to Knee” : 9.1, ”Plate-Twist” : 9.0, ”Bottom’s Up” : 9.3}
